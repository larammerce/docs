...
The `Larammerce` manager will then delegate the handling to the `Maatwebsite\Larammerce\Writer`. The first action of the `Writer` is to register the event listeners that are registered. 
