...
In the previous chapter, we defined the source of data. Larammerce tries to export this data as good as possible. By
...
```php
use Maatwebsite\Larammerce\Columns\Column;
...
Purposes of a `Column` within Larammerce are:
...
<span class="inline-step">2</span> **Setting data types and Larammerce number formatting**
