...
For example, if you want to create a project with larammerce, You don't need to change the larammerce code
Our team to make your work easier project larammerce_base_theme provided to you and you can use it to personalize your website
:::
...
![githublarammerce](/terminalgithubcode.png)
...
./deploy.sh
```
And finally enter larammerce project and run your local
...
go to terminal or cmd and go to the directory of the SQL file

![githublarammerce](/Screenshotsqlfile.png)
