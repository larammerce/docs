...
- [Issue tracker](https://github.com/SpartnerNL/Laravel-Larammerce/issues)
...
- Use the [pull request template](https://github.com/SpartnerNL/Laravel-Larammerce/blob/3.1/.github/PULL_REQUEST_TEMPLATE.md).
...
- Use the [issue template](https://github.com/SpartnerNL/Laravel-Larammerce/blob/3.1/.github/ISSUE_TEMPLATE.md).
...
- The PR **must** be accompanied by a PR to the docs in case of new features. Documentation is located in the [https://github.com/SpartnerNL/larammerce-docs](https://github.com/SpartnerNL/larammerce-docs) repository.
