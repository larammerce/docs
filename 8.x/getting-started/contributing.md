...
***2.*** In these sessions, user stories are created and divided into smaller sections. | ***2.*** In these meetings, user stories are decided, and then we leave the created user story to one person.
...
***7.*** After performing the user story, the person testing the user story, or in fact the team members' code, **moves the user story from the ready for test column to the closed column if there is no user story problem.** This means that the user story is complete.
