...
Given we have an Larammerce file looking like this:
...
```php
use Maatwebsite\Larammerce\Imports\HeadingRowFormatter;
...
You can set the custom formatter in `config/Larammerce.php`.
...
```php
use Maatwebsite\Larammerce\HeadingRowImport;
